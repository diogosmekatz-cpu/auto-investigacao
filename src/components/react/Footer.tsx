  ...
  return (
    <footer className="bg-[#080706] pt-20 pb-10 px-6 rounded-t-[4rem] relative z-20 -mt-10">
      <div className="max-w-6xl mx-auto flex flex-col items-center">
        ...
        <div className="flex flex-col md:flex-row gap-6 md:gap-12 mb-12 font-sans font-light text-sm text-[#F8F5F0]/60">
        ...
        <div className="max-w-3xl text-center font-mono text-[10px] md:text-xs text-[#F8F5F0]/30 leading-relaxed mb-8">
        ...
        <div className="font-sans font-light text-[#F8F5F0]/40 text-sm">
